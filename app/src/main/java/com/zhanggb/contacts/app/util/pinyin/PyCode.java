...
public class PyCode {
    public static Map<String, String> polyCodes = new HashMap<String, String>(100);

    static {
        polyCodes.put("长", "chang zhang");
        polyCodes.put("重", "zhong chong");
        polyCodes.put("无", "wu mo");

        polyCodes.put("省", "sheng xing");
        polyCodes.put("尉", "wei yu");
        polyCodes.put("落", "luo lao la");
        polyCodes.put("剿", "chao jiao");
        polyCodes.put("角", "jue jiao");
        polyCodes.put("嚼", "jiao jue");
        polyCodes.put("茄", "jia qie");
        polyCodes.put("奇", "qi ji");
        polyCodes.put("会", "hui kuai");
        polyCodes.put("吭", "hang keng");
        polyCodes.put("巷", "hang xiang");
        polyCodes.put("给", "gei ji");
        polyCodes.put("行", "xing hang");
        polyCodes.put("冯", "feng ping");
        polyCodes.put("缪", "miao mou miu");
        polyCodes.put("瞿", "ju qu");
        polyCodes.put("曾", "ceng zeng");
        polyCodes.put("石", "dan shi");
        polyCodes.put("解", "jie xie");
        polyCodes.put("折", "she zhe");
        polyCodes.put("藏", "cang zang");
        polyCodes.put("褚", "chu zhu");
        polyCodes.put("景", "ying jing");
        polyCodes.put("翟", "di zhai");
        polyCodes.put("都", "du dou");
        polyCodes.put("薄", "bo bao");
        polyCodes.put("晁", "chao zhao");
        polyCodes.put("贾", "gu jia");
        polyCodes.put("的", "de di");
        polyCodes.put("查", "zha cha");
        polyCodes.put("盛", "cheng sheng");
        polyCodes.put("塔", "da ta");
        polyCodes.put("和", "huo hu he");
        polyCodes.put("柏", "bo bai");
        polyCodes.put("朴", "piao pu po");
        polyCodes.put("牟", "mou mu");
        polyCodes.put("殷", "yin yan");
        polyCodes.put("乾", "qian gan");
        polyCodes.put("陆", "lu liu");
        polyCodes.put("乜", "nie mie");
        polyCodes.put("乐", "yue le");
        polyCodes.put("陶", "yao tao");
        polyCodes.put("叶", "ye xie");
        polyCodes.put("强", "qiang jiang");
        polyCodes.put("不", "fou bu");
        polyCodes.put("阿", "a e");
        polyCodes.put("车", "che ju");
        polyCodes.put("称", "chen cheng");
        polyCodes.put("沈", "chen shen");
        polyCodes.put("区", "ou qu");
        polyCodes.put("仇", "chou qiu");
        polyCodes.put("宿", "su xiu");
        polyCodes.put("南", "na nan");
        polyCodes.put("单", "chan dan shan");
        polyCodes.put("卜", "bo bu");
        polyCodes.put("鸟", "diao niao");
        polyCodes.put("寻", "xin xun");
        polyCodes.put("余", "yu tu");
        polyCodes.put("艾", "ai yi");
        polyCodes.put("浣", "wan huan");
        polyCodes.put("信", "xin shen");
        polyCodes.put("許", "hu xu");
        polyCodes.put("齐", "qi ji");
        polyCodes.put("若", "ruo re");
        polyCodes.put("柞", "zuo zha");
        polyCodes.put("幢", "zhuang chuang");
        polyCodes.put("扒", "ba pa");
        polyCodes.put("蚌", "bang beng");
        polyCodes.put("辟", "bi pi");
        polyCodes.put("扁", "bian pian");
        polyCodes.put("禅", "chan shan");
        polyCodes.put("提", "di ti");
    }
